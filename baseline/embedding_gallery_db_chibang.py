...
if __name__ == "__main__":
    ...
    # Old version: save cả query + gallery vào .mat (giữ lại để tham khảo)
    ...
    # New version: chỉ lưu dữ liệu gallery vào .mat (không lưu query)
    result = {
        'gallery_f': gallery_feature.numpy(),
        'gallery_label': gallery_label,
        'gallery_path': gallery_path,
    }
    scipy.io.savemat('pytorch_result_real_time_chibang_{}.mat'.format(opt.mode), result)
